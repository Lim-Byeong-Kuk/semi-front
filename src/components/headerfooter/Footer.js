...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-gray-400 text-[8px] py-3 px-4">
      <div className="max-w-5xl mx-auto grid grid-cols-[2fr_1fr_1fr] gap-3">
        {/* 회사정보 - 오른쪽 패딩 추가 */}
        <div className="space-y-[2px] md:pr-6">
          {/* 모바일에서 토글 버튼 */}
          <div
            className="flex items-center justify-between md:justify-start text-white mb-[4px] cursor-pointer md:cursor-auto"
          ...
          >
            ...
            <p className="mb-[2px]">
              사업자등록번호 000-00-00000 | 통신판매업신고 2025-성남-0703
              [사업자정보확인]
            </p>
            <p className="mb-[2px]">경기 성남시 xxx xxxxxxx 00-00</p>
            <p className="mb-[2px]">전화 : 000-0000-0000</p>
            <p className="mb-[2px]">
              개인정보보관리책임자 : 아무개 (test@test.co.kr)
            </p>
            <p className="mt-[6px] text-gray-500 text-[9px]">
        ...
        <div className="space-y-[2px] md:px-2">
          <p className="text-white text-[10px] font-semibold">고객센터</p>
          <p className="text-white text-[10px] font-bold">000-0000-0000</p>
          <p>평일 10:00 - 18:00</p>
