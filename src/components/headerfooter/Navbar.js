  ...
  return (
    <>
      ...
      <nav className="w-full bg-gray-50 sticky top-0 z-50 shadow-sm">
        <div className="relative max-w-7xl mx-auto h-8 leading-8 px-4">
          {/* 메뉴 리스트 */}
          <ul className="mx-auto flex justify-center gap-6 text-[10px] font-semibold text-gray-700 overflow-hidden max-w-[calc(100%-160px)] whitespace-nowrap truncate">
          ...
          {/* 아이콘 그룹 */}
          <div className="absolute right-4 top-0 bottom-0 flex items-center gap-4 text-gray-500 text-lg">
